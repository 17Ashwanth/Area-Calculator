...
function Square() {
  ...
  return (
    <>
            <h2 className="text-center fw-bold mt-3">SQUARE</h2>

    <div className='bg-dark text-white justify-content-center align-items-center w-100 p-3 flex-column rounded mt-4'> 
 <h1 className='d-flex justify-content-center align-items-center'>{Display}{' '}cm square</h1>
 <p className='d-flex justify-content-center align-items-center'>Total Area of the Square</p>
  </div>
  <form className='mt-3'>
    <FloatingLabel
          controlId="floatingInput"
          label="Enter The Side"
          className="mb-3"
        >
          <Form.Control style={{fontWeight:'750'}} type="text" autoComplete='off' value={Text} onChange={(e)=>getRadius(e)} placeholder="Enter The Side" />
        </FloatingLabel>
